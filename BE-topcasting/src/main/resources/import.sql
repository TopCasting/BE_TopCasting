...
INSERT INTO PRODUCT (ID, PRODUCT_NAME, PRODUCT_PRICE, IMAGE_ID, DETAILED_IMAGE_ID, MAIN_CATEGORY_ID, SUB_CATEGORY_ID, CREATE_DATE, MODIFY_DATE) VALUES (default,'사파이어14A',9000,1,2,1,1,NOW(),NOW());
INSERT INTO PRODUCT (ID, PRODUCT_NAME, PRODUCT_PRICE, IMAGE_ID, DETAILED_IMAGE_ID, MAIN_CATEGORY_ID, SUB_CATEGORY_ID, CREATE_DATE, MODIFY_DATE)VALUES (default, '사파이어91', 8000, 5, 6, 1, 1, NOW(), NOW());
INSERT INTO PRODUCT (ID, PRODUCT_NAME, PRODUCT_PRICE, IMAGE_ID, DETAILED_IMAGE_ID, MAIN_CATEGORY_ID, SUB_CATEGORY_ID, CREATE_DATE, MODIFY_DATE)VALUES (default, '사파이어40C', 8000, 7, 8, 1, 1, NOW(), NOW());
INSERT INTO PRODUCT (ID, PRODUCT_NAME, PRODUCT_PRICE, IMAGE_ID, DETAILED_IMAGE_ID, MAIN_CATEGORY_ID, SUB_CATEGORY_ID, CREATE_DATE, MODIFY_DATE)VALUES (default, '사파이어103', 12000, 9, 10, 1, 1, NOW(), NOW());
INSERT INTO PRODUCT (ID, PRODUCT_NAME, PRODUCT_PRICE, IMAGE_ID, DETAILED_IMAGE_ID, MAIN_CATEGORY_ID, SUB_CATEGORY_ID, CREATE_DATE, MODIFY_DATE)VALUES (default, '헬라R85새드', 6000, 11, 12, 2, 5, NOW(), NOW()); --6
INSERT INTO PRODUCT (ID, PRODUCT_NAME, PRODUCT_PRICE, IMAGE_ID, DETAILED_IMAGE_ID, MAIN_CATEGORY_ID, SUB_CATEGORY_ID, CREATE_DATE, MODIFY_DATE)VALUES (default, '사라리플새드4인치', 6000, 13, 14, 2, 5, NOW(), NOW());
INSERT INTO PRODUCT (ID, PRODUCT_NAME, PRODUCT_PRICE, IMAGE_ID, DETAILED_IMAGE_ID, MAIN_CATEGORY_ID, SUB_CATEGORY_ID, CREATE_DATE, MODIFY_DATE)VALUES (default, 'T어쌔신5인치', 4000, 15, 16, 2, 5, NOW(), NOW());
INSERT INTO PRODUCT (ID, PRODUCT_NAME, PRODUCT_PRICE, IMAGE_ID, DETAILED_IMAGE_ID, MAIN_CATEGORY_ID, SUB_CATEGORY_ID, CREATE_DATE, MODIFY_DATE)VALUES (default, '5인치 T-LINE(LT)', 6000, 17, 18, 2, 6, NOW(), NOW());
INSERT INTO PRODUCT (ID, PRODUCT_NAME, PRODUCT_PRICE, IMAGE_ID, DETAILED_IMAGE_ID, MAIN_CATEGORY_ID, SUB_CATEGORY_ID, CREATE_DATE, MODIFY_DATE)VALUES (default, '사파이어142', 10000, 3, 4, 1, 1, NOW(), NOW());
INSERT INTO PRODUCT (ID, PRODUCT_NAME, PRODUCT_PRICE, IMAGE_ID, DETAILED_IMAGE_ID, MAIN_CATEGORY_ID, SUB_CATEGORY_ID, CREATE_DATE, MODIFY_DATE)VALUES (default, '5인치 T-LINE(TD)', 6000, 19, 20, 2, 6, NOW(), NOW());
INSERT INTO PRODUCT (ID, PRODUCT_NAME, PRODUCT_PRICE, IMAGE_ID, DETAILED_IMAGE_ID, MAIN_CATEGORY_ID, SUB_CATEGORY_ID, CREATE_DATE, MODIFY_DATE)VALUES (default, '울트라R38C테일', 6000, 21, 22, 2, 6, NOW(), NOW());
INSERT INTO PRODUCT (ID, PRODUCT_NAME, PRODUCT_PRICE, IMAGE_ID, DETAILED_IMAGE_ID, MAIN_CATEGORY_ID, SUB_CATEGORY_ID, CREATE_DATE, MODIFY_DATE)VALUES (default, 'TOP LT 메탈', 8000, 23, 24, 3, 8, NOW(), NOW()); --12
INSERT INTO PRODUCT (ID, PRODUCT_NAME, PRODUCT_PRICE, IMAGE_ID, DETAILED_IMAGE_ID, MAIN_CATEGORY_ID, SUB_CATEGORY_ID, CREATE_DATE, MODIFY_DATE)VALUES (default, '대구전용 메탈', 12000, 25, 26, 3, 8, NOW(), NOW());
INSERT INTO PRODUCT (ID, PRODUCT_NAME, PRODUCT_PRICE, IMAGE_ID, DETAILED_IMAGE_ID, MAIN_CATEGORY_ID, SUB_CATEGORY_ID, CREATE_DATE, MODIFY_DATE)VALUES (default, 'TPIAA 털스푼', 5000, 27, 28, 3, 9, NOW(), NOW());
